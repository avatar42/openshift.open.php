...
<br>
<br>
UPDATE 6/20/2004: Well now I&apos;m getting a fair number of emails to all those random addresses the spam generator used so I&apos;ve rewritten the parser to assume anything that it can not confirm as a bounce as spam sent direct. This might result in a few reports that are really bounces by spam software but I&apos;m checking for bounce format of the return-path, various key words in the from address and a spam assassin info line to see if it is truly a bounce. If it has none of these things they probably need an email to configure their servers correctly. After all if servers are going to talk to servers we need to use some sort of formatting.<br>
<br>
UPDATE 6/10/2004: Well it&apos;s been 2 months since I&apos;ve had time to update this site! Between 12 hours per at my day job and the increase in faked and corrupted headers in the emails there has not been much time for anything else. I finally gave up on previous parsing methods that assumed people would follow some sort of standards and am now dumping all header lines into a buffer for sorting and filtering before attempting to process them. (See <A href=/downloads>Get SpamRescue</a>) All the spam and virus filters being added out there are only making things worse by adding badly formatted lines of their own or corrupting the headers in their reports. I&apos;ve seen as many as 5 Received: lines added in 1 email alone by filters. Another popular spam filter has bounced  faked spam back to me with good headers, but no body, in 1 attachment and corrupted headers in the "original email" attachment. It seems that many spam processors that actually look at Received: lines are now saying they will only process the line added by their server. As far as I know I am still the only one even attempting to process bounce backs. Anyway I think version 3.1.1 is working well enough to hold me for awhile and since I&apos;m down to about 30 "<A href=whatisspam.php>true</a>" spams and viruses a day I will probably not be putting too much more time into improvements till the next new trick comes along.<br>
<br>
